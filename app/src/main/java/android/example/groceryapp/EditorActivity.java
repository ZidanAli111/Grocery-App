...
public class EditorActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNameEditText = (EditText) findViewById(R.id.edit_p_name);
        mModelEditText = (EditText) findViewById(R.id.edit_p_model);
        mQuantityEditText = (EditText) findViewById(R.id.edit_p_quantity);
        mGradeSpinner = (Spinner) findViewById(R.id.edit_spinner_gender);
        mPrice = (EditText) findViewById(R.id.edit_p_price);
        mSupplierEmail = (EditText) findViewById(R.id.edit_s_id);
    ...
    private boolean saveProduct() {
        ...
        // optional, nullable
        values.put(ProductEntry.COLUMN_SUPPLIER_ID, supplierEmailString);    // optional, nullable
