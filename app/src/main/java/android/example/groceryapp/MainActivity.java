...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>  {
    ...
    *
    ...
    private void insertProduct() {
        ...
        values.put(ProductEntry.COLUMN_SUPPLIER_ID, getString(R.string.dummy_data_supplier_email));

        values.put(ProductEntry.COLUMN_PRODUCT_PRICE, 296989.98);
